...
UserList(Resucitador).Stats.MinSta = 50
UserList(Resucitador).Stats.MinAGU = 100
UserList(Resucitador).Stats.MinHam = 100
...
If Lleno Then
    ...
    UserList(UserIndex).flags.Sed = 100
    UserList(UserIndex).flags.Hambre = 100
Else
    UserList(UserIndex).Stats.MinHP = UserList(UserIndex).Stats.MaxHP
    UserList(UserIndex).Stats.MinSta = 50
    UserList(UserIndex).Stats.MinMAN = UserList(UserIndex).Stats.MaxMAN
...
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 18500 And Npclist(NpcIndex).Stats.MinHP < 19000 Then Call SendData(ToAll, 0, 0, "||El rey del Castillo está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 16500 And Npclist(NpcIndex).Stats.MinHP < 17000 Then Call SendData(ToAll, 0, 0, "||El rey del Castillo está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 13500 And Npclist(NpcIndex).Stats.MinHP < 14000 Then Call SendData(ToAll, 0, 0, "||El rey del Castillo está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 11500 And Npclist(NpcIndex).Stats.MinHP < 12000 Then Call SendData(ToAll, 0, 0, "||El rey del Castillo está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 9500 And Npclist(NpcIndex).Stats.MinHP < 10000 Then Call SendData(ToAll, 0, 0, "||Al rey de castillo le queda menos de la mitad de la vida, y está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 6000 And Npclist(NpcIndex).Stats.MinHP < 6500 Then Call SendData(ToAll, 0, 0, "||Al rey del castillo le queda muy poca vida, y está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 3000 And Npclist(NpcIndex).Stats.MinHP < 3500 Then Call SendData(ToAll, 0, 0, "||Al rey del castillo le queda muy poca vida, y está siendo atacado!" & FONTTYPE_FENIX)
If Npclist(NpcIndex).POS.Map = Mapa_Castillo And Npclist(NpcIndex).Name = "Rey del Castillo" And Npclist(NpcIndex).Stats.MinHP > 1000 And Npclist(NpcIndex).Stats.MinHP < 1500 Then Call SendData(ToAll, 0, 0, "||El rey del Castillos está apunto de morir!" & FONTTYPE_FENIX)
...
End Sub
Public Sub ResetUsuario(ByVal UserIndex As Integer)
Dim i As Byte
Dim Y As Byte
...
'For Y = 1 To MAXUSERHECHIZOS
' UserList(UserIndex).Stats.UserHechizos(Y) = "0"
'Next Y
...
On Error GoTo ErrorHandler
If UserList(UserIndex).flags.GrupoAzul = True Then
UserList(UserIndex).Stats.MinHP = 100
Call WarpUserChar(UserIndex, 6, 22, 11, True)
...
Exit Sub
End If
If UserList(UserIndex).flags.GrupoRojo = True Then
UserList(UserIndex).Stats.MinHP = 100
Call WarpUserChar(UserIndex, 6, 78, 11, True)
...
If UserList(UserIndex).flags.GuerraFciuda Then
guerra_ciudas = guerra_ciudas + 1
Call WarpUserChar(UserIndex, 1, 50, 50, False)
If guerra_ciudas = guerra Then
GuerraPremiocrimi = True
GuerraPremiociuda = False
End If
End If

If UserList(UserIndex).flags.GuerraFcrimi Then
guerra_crimis = guerra_crimis + 1
Call WarpUserChar(UserIndex, 1, 50, 50, False)
If guerra_crimis = guerra Then
GuerraPremiocrimi = False
GuerraPremiociuda = True
End If
End If

If UserList(UserIndex).flags.EnDeath = True Then
 Call SendData(ToAll, 0, 0, "||AutoDeath> El usuario " & UserList(UserIndex).Name & " ha muerto.~255~0~255~0~0" & FONTTYPE_INFO)
 Call WarpUserChar(UserIndex, 1, 50, 50, False)
...
'Sistema de Honor - Peto.

UserList(UserIndex).flags.Honor = UserList(UserIndex).flags.Honor - 10

If UserList(UserIndex).flags.EnDuelo = True Then
       UserList(UserIndex).flags.EnDuelo = False
        Call WarpUserChar(UserIndex, 200, 50, 50)
        Call SendData(ToAll, 0, 0, "||Duelos> " & UserList(UserIndex).Name & " ha sido vencido en la sala de duelos." & FONTTYPE_TALK)
    End If
