...
Private Const mapatorneo As Integer = 190
' esquinas superior isquierda del ring
Private Const esquina1x As Integer = 66
Private Const esquina1y As Integer = 13
' esquina inferior derecha del ring
Private Const esquina2x As Integer = 86
Private Const esquina2y As Integer = 24
' Donde esperan los tios
Private Const esperax As Integer = 70
Private Const esperay As Integer = 50
' Mapa desconecta
...
Private Const X1 As Integer = 55
Private Const X2 As Integer = 71
Private Const Y1 As Integer = 47
Private Const Y2 As Integer = 56
...
End If
    ...
    If (Torneo_Rondas = 1) Then
        ...
        Call SendData(ToAll, 0, 0, "||PREMIO: 1.000.000 de oro, 1 punto de torneo y 1 de canjeo." & FONTTYPE_GUILD)
        UserList(Torneo_Luchadores(LI1)).flags.Canje = UserList(Torneo_Luchadores(LI1)).flags.Canje + 1
