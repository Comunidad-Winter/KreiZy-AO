...
Public ganogrupoAZUL As Boolean
Public ganogrupoROJO As Boolean
Public pocionroja As Integer
Public XX1 As Integer
Public XX2 As Integer
Public ii As Integer

Public GuerraPremiociuda As Boolean
Public GuerraPremiocrimi As Boolean
Public guerra_ciudas As Integer
Public guerra_crimis As Integer
Public ganocrimi As Integer
Public ganociuda As Integer
Public Hay_guerra As Boolean
Public guerra As Integer
Public aaa As Integer
Public yaganoo As Boolean

Public Anticheatt As Boolean

Public intervalovida As Integer

Public Death As Integer
Public Death_Muertos As Integer

Public asddd As Integer

Public asdd As Integer
Public yagano As Integer

Public hay_Quest As Boolean
Public Questt As Integer
Public Quest_cantidad As Integer
Public death_termina As Integer
...
Public Castillo As String
Public DiaC As String
Public HoraC As String
Public Const Mapa_Castillo = 4 'el "X" lo reemplazan por el mapa del castillo

Public conquistador As Integer
Public diaq As Integer
Public horaq As Integer
Public Const mapa_quest = 6
...
Public Const TIEMPO_INICIOMEDITAR = 1
...
Public Const EsfuerzoPescarGeneral = 1
...
Type UserFlags
    Desconecto As Integer
    VIP As Byte ' simp
    GanoQuest As Integer
    Tdeath As Integer
    Honor As Long
    Chitero As Integer
    Enguerra As Boolean
    GuerraFciuda As Boolean
    GuerraFcrimi As Boolean
    Chiteando As Byte
    EnDeath As Boolean
    ...
    Canje As Integer
    Queladoes As Boolean
    GrupoRojo As Boolean
    GrupoAzul As Boolean
    Estaenlaquest As Boolean
