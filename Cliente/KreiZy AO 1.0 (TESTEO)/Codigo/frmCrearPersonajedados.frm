...
Begin VB.Form frmCrearPersonaje 
   ...
   Begin VB.ComboBox lstGenero 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   345
      ItemData        =   "frmCrearPersonajedados.frx":81294
      Left            =   6000
      List            =   "frmCrearPersonajedados.frx":8129E
   ...
   Begin VB.ComboBox lstRaza 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   345
      ItemData        =   "frmCrearPersonajedados.frx":812B1
      Left            =   3840
      List            =   "frmCrearPersonajedados.frx":812C4
      Style           =   2  'Dropdown List
      TabIndex        =   34
      Top             =   3600
      Width           =   2040
   ...
   Begin VB.ComboBox lstHogar 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   345
      ItemData        =   "frmCrearPersonajedados.frx":812F1
      Left            =   3840
      List            =   "frmCrearPersonajedados.frx":81304
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   38
      Top             =   4320
   ...
   Begin VB.Image Image1 
      Height          =   615
      Left            =   1320
      MouseIcon       =   "frmCrearPersonajedados.frx":81335
   ...
   Begin VB.Image command1 
      ...
      Index           =   42
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":8163F
      MousePointer    =   99  'Custom
      Top             =   7680
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   43
      Left            =   5160
      MouseIcon       =   "frmCrearPersonajedados.frx":81791
      MousePointer    =   99  'Custom
      Top             =   7680
      Width           =   195
   End
   ...
   Begin VB.Image command1 
      ...
      Index           =   3
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":818E3
      MousePointer    =   99  'Custom
      Top             =   5400
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   5
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":81A35
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   7
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":81B87
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   9
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":81CD9
      MousePointer    =   99  'Custom
      Top             =   6240
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   11
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":81E2B
      MousePointer    =   99  'Custom
      Top             =   6480
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   13
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":81F7D
      MousePointer    =   99  'Custom
      Top             =   6720
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   15
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":820CF
      MousePointer    =   99  'Custom
      Top             =   7080
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   17
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":82221
      MousePointer    =   99  'Custom
      Top             =   7320
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   19
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":82373
      MousePointer    =   99  'Custom
      Top             =   7680
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   21
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":824C5
      MousePointer    =   99  'Custom
      Top             =   7920
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   23
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":82617
      MousePointer    =   99  'Custom
      Top             =   5040
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   25
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":82769
      MousePointer    =   99  'Custom
      Top             =   5400
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   27
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":828BB
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   1
      Left            =   2400
      MouseIcon       =   "frmCrearPersonajedados.frx":82A0D
      MousePointer    =   99  'Custom
      Top             =   5040
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   0
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":82B5F
      MousePointer    =   99  'Custom
      Top             =   5040
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   2
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":82CB1
      MousePointer    =   99  'Custom
      Top             =   5400
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   4
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":82E03
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   6
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":82F55
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   8
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":830A7
      MousePointer    =   99  'Custom
      Top             =   6240
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   10
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":831F9
      MousePointer    =   99  'Custom
      Top             =   6480
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   12
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":8334B
      MousePointer    =   99  'Custom
      Top             =   6840
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   14
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":8349D
      MousePointer    =   99  'Custom
      Top             =   7080
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   16
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":835EF
      MousePointer    =   99  'Custom
      Top             =   7320
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   18
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":83741
      MousePointer    =   99  'Custom
      Top             =   7680
      Width           =   150
   End
   Begin VB.Image command1 
      ...
      Index           =   20
      Left            =   3000
      MouseIcon       =   "frmCrearPersonajedados.frx":83893
      MousePointer    =   99  'Custom
      Top             =   7920
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   22
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":839E5
      MousePointer    =   99  'Custom
      Top             =   5040
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   24
      Left            =   5760
      MouseIcon       =   "frmCrearPersonajedados.frx":83B37
      MousePointer    =   99  'Custom
      Top             =   5280
      Width           =   255
   End
   Begin VB.Image command1 
      ...
      Index           =   26
      Left            =   5760
      MouseIcon       =   "frmCrearPersonajedados.frx":83C89
      MousePointer    =   99  'Custom
      Top             =   5640
      Width           =   270
   End
   Begin VB.Image command1 
      ...
      Index           =   28
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":83DDB
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   29
      Left            =   5160
      MouseIcon       =   "frmCrearPersonajedados.frx":83F2D
      MousePointer    =   99  'Custom
      Top             =   5880
      Width           =   285
   End
   Begin VB.Image command1 
      ...
      Index           =   32
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":8407F
      MousePointer    =   99  'Custom
      Top             =   6240
      Width           =   180
   End
   Begin VB.Image command1 
      ...
      Index           =   33
      Left            =   5160
      MouseIcon       =   "frmCrearPersonajedados.frx":841D1
      MousePointer    =   99  'Custom
      Top             =   6120
      Width           =   300
   End
   Begin VB.Image command1 
      ...
      Index           =   34
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":84323
      MousePointer    =   99  'Custom
      Top             =   6480
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   35
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":84475
      MousePointer    =   99  'Custom
      Top             =   6480
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   36
      Left            =   5760
      MouseIcon       =   "frmCrearPersonajedados.frx":845C7
      MousePointer    =   99  'Custom
      Top             =   6720
      Width           =   255
   End
   Begin VB.Image command1 
      ...
      Index           =   37
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":84719
      MousePointer    =   99  'Custom
      Top             =   6840
      Width           =   195
   End
   Begin VB.Image command1 
      ...
      Index           =   38
      Left            =   5880
      MouseIcon       =   "frmCrearPersonajedados.frx":8486B
      MousePointer    =   99  'Custom
      Top             =   7080
      Width           =   135
   End
   Begin VB.Image command1 
      ...
      Index           =   39
      Left            =   5280
      MouseIcon       =   "frmCrearPersonajedados.frx":849BD
      MousePointer    =   99  'Custom
      Top             =   7080
      Width           =   165
   End
   Begin VB.Image command1 
      ...
      Index           =   40
      Left            =   5760
      MouseIcon       =   "frmCrearPersonajedados.frx":84B0F
      MousePointer    =   99  'Custom
      Top             =   7320
      Width           =   285
   End
   Begin VB.Image command1 
      ...
      Index           =   41
      Left            =   5160
      MouseIcon       =   "frmCrearPersonajedados.frx":84C61
      MousePointer    =   99  'Custom
      Top             =   7320
      Width           =   255
   End
   Begin VB.Image boton 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "frmCrearPersonajedados.frx":84DB3
      MousePointer    =   99  'Custom
      Top             =   8400
      Width           =   1125
   End
   Begin VB.Image boton 
      ...
      Index           =   0
      Left            =   9720
      MouseIcon       =   "frmCrearPersonajedados.frx":84F05
      MousePointer    =   99  'Custom
      Top             =   8400
      Width           =   2280
   End
    ...
    Case 0
        ...
        If CheckData() Then
            ...
            If Not CheckMailString(UserEmail) Then
                MsgBox "Direccion de mail inválida.", vbExclamation, "ValZhatAO"
                txtCorreo.SetFocus
                Exit Sub
            End If
    
            If UserEmail <> txtCorreo2.Text Then
                MsgBox "Las direcciones de mail no coinciden.", vbExclamation, "ValZhatAO"
                txtCorreo2.Text = ""
                txtCorreo2.SetFocus
                Exit Sub
            End If
            ...
            If Len(Trim(txtPasswd)) = 0 Then
                MsgBox "Tenés que ingresar una contraseña.", vbExclamation, "ValZhatAO"
                txtPasswd.SetFocus
                Exit Sub
            End If
            
            If Len(Trim(txtPasswd)) < 6 Then
                MsgBox "El password debe tener al menos 6 caracteres.", vbExclamation, "ValZhatAO"
                txtPasswd = ""
                txtPasswdCheck = ""
                txtPasswd.SetFocus
                Exit Sub
            ...
            If Trim(txtPasswd) <> Trim(txtPasswdCheck) Then
                MsgBox "Las contraseñas no coinciden.", vbInformation, "ValZhatAO"
                txtPasswd = ""
                txtPasswdCheck = ""
                txtPasswd.SetFocus
                Exit Sub
