...
Dim rdata4
    ...
    Select Case sdata
        ...
        Case "SFSDAF"
            Call SetMusicInfoO("Jugando ValZhatAO, Nick: " & UserName & ", Nivel: " & UserLvl & ",Oro: " & UserGLD & " ", " ", "www.ValZhatao.ucoz.com")
            Sincroniza = Timer
            logged = True
            UserCiego = False
            EngineRun = True
...
Select Case Left$(Rdata, 2)
        ...
        Case "!4"
            ...
            Exit Sub
        Case "/O"
If Not Conteosa = False And Not Conteosb = False And Not Conteosc = False Then
Call Dialogos.BorrarDialogos
Conteosa = False
Conteosc = False
Conteosb = False
...
End If
             If Not Conteosa = False And Not Conteosb = False And Not Conteosc = True Then
      lardatac = Right$(Rdata, Len(Rdata) - 2)
      Conteosc = True
      frmPrincipal.Timer8.Enabled = False
      frmPrincipal.Timer8.Enabled = True
  
frmPrincipal.Timer8.Interval = 13000
  End If
  
 If Conteosa = True And Conteosb = False Then
 lardatab = Right$(Rdata, Len(Rdata) - 2)
 Conteosb = True
 frmPrincipal.Timer7.Enabled = False
 frmPrincipal.Timer7.Enabled = True
frmPrincipal.Timer7.Interval = 13000

 End If
 If Conteosa = False Then
  lardataa = Right$(Rdata, Len(Rdata) - 2)
  Conteosa = True
  frmPrincipal.Timer6.Enabled = False
  frmPrincipal.Timer6.Enabled = True
frmPrincipal.Timer6.Interval = 13000
End If
           Exit Sub
        Case "/P"
            Rdata = Right$(Rdata, Len(Rdata) - 2)
