...
Connected = True
Call AddtoRichTextBox(frmPrincipal.rectxt, UserName & " Bienvenido a ValZhatAO 1.0.", 29, 108, 205, 2, 1)
...
frmPres.Picture = LoadPicture(App.Path & "\Graficos\cargando.jpg")
...
Do While prgRun
    ...
    End If
        ...
        If GetTickCount - lFrameTimer >= 1000 Then
            ...
            If FPSFLAG Then frmPrincipal.Caption = "ValZhatAO" & " V " & App.Major & "." & App.Minor & ""
